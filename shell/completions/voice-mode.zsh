#!/bin/zsh
# Zsh completion for voice-mode command (using Click-generated completions)
...
#
# Usage:
#   Source directly:  source ~/.voicemode/shell/completions/voice-mode.zsh
...
if command -v voice-mode &> /dev/null; then
    ...
    eval "$(_VOICE_MODE_COMPLETE=zsh_source voice-mode 2>/dev/null)"
