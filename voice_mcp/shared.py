...
from .config import (
    ...
    AUDIO_FEEDBACK_ENABLED, AUDIO_FEEDBACK_VOICE,
    AUDIO_FEEDBACK_MODEL, AUDIO_FEEDBACK_STYLE,
    STT_BASE_URL, TTS_BASE_URL, TTS_VOICE, TTS_MODEL, STT_MODEL,
    OPENAI_API_KEY, OPENAI_TTS_BASE_URL, KOKORO_TTS_BASE_URL,
    LIVEKIT_URL, LIVEKIT_API_KEY, LIVEKIT_API_SECRET,
    AUTO_START_KOKORO, ALLOW_EMOTIONS, EMOTION_AUTO_UPGRADE, PREFER_LOCAL,
